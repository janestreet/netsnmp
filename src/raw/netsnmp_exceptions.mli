...
(** General_error (os_err, snmp_error, error_string) [os_error] is the value of the system
    errno and [error_string] a string interpretation of both [os_err] and [snmp_error] *)
