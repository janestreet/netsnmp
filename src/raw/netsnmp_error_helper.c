...
int snmperr_to_ml_variant(int err) {
  ...
  case SNMPERR_GENERR:
    return 1;
  case SNMPERR_BAD_LOCPORT:
    return 2;
  case SNMPERR_BAD_ADDRESS:
    return 3;
  case SNMPERR_BAD_SESSION:
    return 4;
  case SNMPERR_TOO_LONG:
    return 5;
  case SNMPERR_NO_SOCKET:
    return 6;
  case SNMPERR_V2_IN_V1:
    return 7;
  case SNMPERR_V1_IN_V2:
    return 8;
  case SNMPERR_BAD_REPEATERS:
    return 9;
  case SNMPERR_BAD_REPETITIONS:
    return 10;
  case SNMPERR_BAD_ASN1_BUILD:
    return 11;
  case SNMPERR_BAD_SENDTO:
    return 12;
  case SNMPERR_BAD_PARSE:
    return 13;
  case SNMPERR_BAD_VERSION:
    return 14;
  case SNMPERR_BAD_SRC_PARTY:
    return 15;
  case SNMPERR_BAD_DST_PARTY:
    return 16;
  ...
  case SNMPERR_NOAUTH_DESPRIV:
    return 19;
  case SNMPERR_BAD_ACL:
    return 20;
  case SNMPERR_BAD_PARTY:
    return 21;
  case SNMPERR_ABORT:
    return 22;
  case SNMPERR_UNKNOWN_PDU:
    return 23;
  case SNMPERR_TIMEOUT:
    return 24;
  case SNMPERR_BAD_RECVFROM:
    return 25;
  ...
  case SNMPERR_BAD_SEC_LEVEL:
    return 28;
  case SNMPERR_ASN_PARSE_ERR:
    return 29;
  case SNMPERR_UNKNOWN_SEC_MODEL:
    return 30;
  case SNMPERR_INVALID_MSG:
    return 31;
  ...
  case SNMPERR_DECRYPTION_ERR:
    return 37;
  case SNMPERR_SC_GENERAL_FAILURE:
    return 38;
  case SNMPERR_SC_NOT_CONFIGURED:
    return 39;
  case SNMPERR_KT_NOT_AVAILABLE:
    return 40;
  case SNMPERR_UNKNOWN_REPORT:
    return 41;
  ...
  case SNMPERR_UNKNOWN_OBJID:
    return 58;
  case SNMPERR_NULL_PDU:
    return 59;
  case SNMPERR_NO_VARS:
    return 60;
  case SNMPERR_VAR_TYPE:
    return 61;
  case SNMPERR_MALLOC:
    return 62;
  case SNMPERR_KRB5:
    return 63;
  case SNMPERR_PROTOCOL:
    return 64;
  case SNMPERR_OID_NONINCREASING:
    return 65;
  case SNMPERR_JUST_A_CONTEXT_PROBE:
    return 66;
  default:
    return 1;
  }
