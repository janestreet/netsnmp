...
(** [to_hex_string] converts a bitstring into a hex string with octet values separated by
    [sep]. [sep] defaults to space. *)
...
(** [to_string] converts a bitstring to a string in the format
    [Hex-Bytes BITS(Numbers of each set bit)]. eg [99 CC BITS(0 3 4 7 8 9 12 13)]. The
    left most bit is bit 0. *)
